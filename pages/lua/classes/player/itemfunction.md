<function name="ItemFunction" parent="Player" type="classfunc">
	<description>
		Calls the given callback function of the player's primary item, checking their active effects first via <page>Player:ItemFunctionInternal</page>.
	</description>
	<realm>Shared</realm>
	<group>Items</group>
	<args>
