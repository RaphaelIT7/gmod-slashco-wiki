<function name="RegisterPerk" parent="SlashCo" type="libraryfunc">
	<description>
		...
		Conflict IDs are also converted into lookup keys within the <page>PERK#Conflicts</page> table.
	</description>
	<realm>Shared</realm>
	<group>Perks</group>
	<args>
		<arg name="perkTbl" type="Perk">The <page>PERK</page> table to register</arg>
