<function name="Jumpscare" parent="SlashCo" type="libraryfunc">
	<description>
		...
		On success it freezes both entities, plays the slasher's kill sound, and after <page>SLASHER#JumpscareDuration</page> seconds deals fatal damage to the target and calls the slasher's <page>SLASHER#OnKillPlayer</page> function via <page>Player:SlasherFunction</page>.
	</description>
	<realm>Server</realm>
	<group>Slasher</group>
	<args>
